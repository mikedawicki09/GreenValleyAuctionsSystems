<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeFacingMaster.Master" AutoEventWireup="true" CodeBehind="MoveServiceCompletionForm.aspx.cs" Inherits="GreenValleyAuctionsSystems.MoveServiceCompletionForm" %>
            ...
            <div id="popup1" class="overlay" style="float: right;">
                <div class="popup shadow-lg pop">
                    ...
                    <div class=" container col-md-12 text-center" style="margin-top: 10px;">
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-success text-white" OnClick="btnSubmit_Click" />
                    </div>
                </div>
            </div>
    </section>
