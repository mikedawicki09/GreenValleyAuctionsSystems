...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnExistingCustomer" runat="server" Text="Existing Customer" BackColor="Gray"  Class="btn btn-success text-white" OnClick="btnExistingCustomer_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnNewCustomer" runat="server" Text="New Customer"   Class="btn btn-success text-white" OnClick="btnNewCustomer_Click" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    ...
    <asp:Table ID="Table4" runat="server" HorizontalAlign="Center">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnSave" runat="server" Text="Save"  class="btn btn-success text-white" OnClick="btnSave_Click" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
