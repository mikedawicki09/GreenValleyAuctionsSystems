...
{
    public partial class MoveServiceCompletionForm : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sqlQuery = "SELECT CUSTOMER.firstName, CUSTOMER.lastName, CUSTOMER.emailAddress, CUSTOMER.phoneNumber, " +
                    "CUSTOMER.streetAddress + ' ' + CUSTOMER.city + ', ' + CUSTOMER.state + ' ' + CUSTOMER.zipcode AS 'Customer Address', MOVINGSERVICE.dateOfService, SERVICE.serviceName, MOVINGSERVICE.totalCost, MOVINGSERVICE.paymentType " +
                    " FROM dbo.CUSTOMER, dbo.MOVINGSERVICE, dbo.SERVICE";
                sqlQuery += " WHERE CUSTOMER.customerID = '" + Session["customerID"].ToString() + "' AND SERVICE.serviceID = MOVINGSERVICE.serviceID";
